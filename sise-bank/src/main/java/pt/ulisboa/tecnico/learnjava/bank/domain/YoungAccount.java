...
public class YoungAccount extends SavingsAccount {
	...
	public CheckingAccount upgrade() throws BankException, AccountException, ClientException, ServicesException {
		Client client = this.getClient();

		client.getBank().deleteAccount(this);

		int amount = this.getBalance() + 2 * (this.getPoints() / 1000);
