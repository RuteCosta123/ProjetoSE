...
public class Client {
	...
	public Client(Bank bank, String firstName, String lastName, String nif, String phoneNumber, String address, int age)
		...
		this.checkParameters(bank, nif, phoneNumber, age);
	...
	public void happyBirthDay() throws BankException, AccountException, ClientException, ServicesException {
		this.age++;
...
//	public long getCodigoMbway() {
//		return this.codigoMbway;
//	}
//
//	public void setCodigoMbway(long codigoMbway) {
//		this.codigoMbway = codigoMbway;
//	}
}
