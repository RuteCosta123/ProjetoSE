...
public class HappyBirthdayMethodTest {
	...
	@Before
	public void setUp() throws AccountException, ClientException, BankException, ServicesException {
	...
	@Test
	public void successNoUpgrade() throws BankException, AccountException, ClientException, ServicesException {
	...
	@Test
	public void successUpGrade() throws BankException, AccountException, ClientException, ServicesException {
		this.youngClient.happyBirthDay();
		this.youngClient.happyBirthDay();
